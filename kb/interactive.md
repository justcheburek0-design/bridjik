...
# Голосовые сообщения
Если хочешь ответить голосовым сообщением, используй тег `[[voice:Текст сообщения]]`. Текст внутри тега будет озвучен и отправлен отдельно.
Используй это, когда тебя просят записать голосовое или когда это уместно для контекста.