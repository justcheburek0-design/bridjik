...
# Compute project root to keep data dirs stable after packaging into src/minebridge
if THIS_DIR.name == "minebridge" and THIS_DIR.parent.name == "src":
    ROOT_DIR = THIS_DIR.parent.parent
else:
    ROOT_DIR = THIS_DIR
KB_DIR = ROOT_DIR / "kb"          # положите сюда .txt/.md файлы
RAG_INDEX_DIR = ROOT_DIR / ".rag_cache"
