...
PSEVDO_FILE = BASE_DIR / "config/psevdos.json"
HISTORY_FILE = BASE_DIR / "config/history.json"
CHAT_LOGS_FILE = BASE_DIR / "config/chat_logs.json"
FREEZES_FILE = BASE_DIR / "config/freezes.json"
RAG_CHUNK_SIZE = 900
